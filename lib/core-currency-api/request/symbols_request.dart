...
final class SymbolsRequest extends GetRequest<SymbolsResponse> {
  SymbolsRequest(ResponseModelMapper<SymbolsResponse> dataModelMapper) :
        super("/api/symbols", dataModelMapper, cacheSettings: CacheSettings(CacheRule.forceCache, const Duration(days: 1)));
}
